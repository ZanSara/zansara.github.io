...
![Hybrid Retrieval](hybrid-retrieval-inv.png)
...
![Ranker Documentation](ranker-docs-inv.png)
...
![Query Classification vs Hybrid Retrieval](branching-query-pipelines-inv.png)
...
![Multilingual Hybrid Retrieval](multilingual-hybrid-retrieval-inv.png)
...
![Multilingual Hybrid Retrieval with No-Op Joiner](multilingual-hybrid-retrieval-with-noop-inv.png)
...
![Multilingual Hybrid Retrieval with two Translators](multilingual-hybrid-retrieval-two-translators-inv.png)
...
![Multilingual Hybrid Retrieval, translate-and-distribute](multilingual-hybrid-retrieval-translate-and-distribute-inv.png)
...
![Multilingual Hybrid Retrieval, working version](multilingual-hybrid-retrieval-workaround-inv.png)
...
![Indexing Pipeline](indexing-pipeline-inv.png)
...
![`FileTypeClassifier documentation`](filetypeclassifier-docs-inv.png)
...
![All branching pipelines, side by side](all-branching-pipelines-inv.png)
...
![Swapper Retriever/Reader Pipeline](swapped-retriever-reader-inv.png)
